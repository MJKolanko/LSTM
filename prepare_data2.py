...
Zapisuje w dataset/{train,val}/mix.wav i dataset/{train,val}/s1.wav, s2.wav
"""
...
def main():
    ...
    parser.add_argument("--clean_dir", default="data/clean_spk2", help="folder with spk1, spk2, ...")
    parser.add_argument("--noise_dir", default="data/noise", help="noise wavs (optional)")
    parser.add_argument("--out_dir", default="dataset2", help="output dataset base")
