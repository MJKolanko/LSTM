...
def main():
    ...
    parser.add_argument("--model", required=True, default="sep_model2.pt", help="Ścieżka do sep_model.pt")
    parser.add_argument("--input", required=True, help="Plik .wav z mixem")
    parser.add_argument("--outdir", default="sep_output2", help="Gdzie zapisać wyniki")
